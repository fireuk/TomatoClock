 ...
 */
package com.example.tomatoclock.calendarview;
...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.example.tomatoclock.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.example.tomatoclock.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
